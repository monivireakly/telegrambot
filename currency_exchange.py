...
to_currency = ['THB', 'AUD', 'EUR', 'GBP', 'CNH']
from_currency = ['USD', 'USD', 'USD', 'USD', 'USD']

querystring = {"to": to_currency, "from": from_currency, "q": "1.0"}
...
# result = f'One {from_currency} is equal to {response.text} {to_currency}'
